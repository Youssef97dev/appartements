      ...
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <span>
            ...
            <span className="ml-1"> {data.city}</span>
          </span>
        </div>
  ...
  const renderSection8 = () => {
    return (
      <div className="listingSection__wrap">
        ...
        <div>
          ...
          <div className="mt-3 text-neutral-500 dark:text-neutral-400 max-w-md text-sm sm:text-base">
            <div className="flex space-x-10 justify-between p-3 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
              <span>Check-in</span>
              <span>03:00 PM - 11:00 PM</span>
            </div>
            <div className="flex space-x-10 justify-between p-3">
              <span>Check-out</span>
              <span>before 12:00 AM</span>
            </div>
          </div>
        </div>
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700" />
        ...
        {/* CONTENT */}
        <div>
          <h4 className="text-lg font-semibold">Internal regulations</h4>
          <div className="prose sm:prose">
            <ul className="mt-3 text-neutral-500 dark:text-neutral-400 space-y-2">
              <li>No pets.</li>
              <li>Quiet hours must be observed from 11:00 PM to 7:00 AM</li>
              <li>No parties or evenings</li>
